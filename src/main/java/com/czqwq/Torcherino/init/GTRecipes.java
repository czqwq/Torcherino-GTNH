...
public class GTRecipes {
    ...
    public static void loadRecipes() {
        // ========== Perfect Time Twister (Assembly Line, existing) ==========
        ...
        // 4 clocks + 1 torch, NC programming circuit 4 → regular torcherino
        GTValues.RA.stdBuilder()
            .itemInputs(
        ...
        // ========== Wireless Torcherino Compressor Recipes (HIP required) ==========
        // 256 regular torcherinos → 1 wireless torcherino
        // Uses itemInputsUnsafe + copyAmountUnsafe to bypass the 64-stack-size cap
        GTValues.RA.stdBuilder()
        ...
        // ========== Bidirectional Torcherino ↔ Classic Conversions ==========
