package com.czqwq.Torcherino.entity;

import static com.czqwq.Torcherino.Torcherino.LOG;
...
public class EntityTimeAccelerator extends Entity {
    ...
    // region Fields
    private int timeRate = 4; // must be set in here for texture render init
    ...
    public EntityTimeAccelerator(World worldIn) {
        ...
        // this entity setting must modify with TimeVial field double tHalfSize = 0.01D
